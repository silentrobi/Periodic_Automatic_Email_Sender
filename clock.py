...
def job():
    ...
    apiRouteIstanbul = apiRouteIstanbul + str(getPreviousWeek) # Need to change to getPreviousWeek

    apiRouteIzmir = apiRouteIzmir + str(getPreviousWeek)  # Need to change to getPreviousWeek
